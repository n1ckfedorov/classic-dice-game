...
const buttonVariants = cva(
  'inline-flex cursor-pointer items-center justify-center text-center transition-all duration-200',
  {
    variants: {
      variant: {
        brand: 'bg-gradient-to-r from-[#24ee89] to-[#9fe871] font-extrabold text-black shadow-[0_12px_0_0_rgba(35,238,136,0.3)] shadow-[inset_0_-2px_0_0_#1dca6a] hover:shadow-[0_0px_2px_0_rgba(36,238,137,0.5)] hover:brightness-110 active:scale-95',
